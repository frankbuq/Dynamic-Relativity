...
\fancyhead[R]{Human-AI Symbiotic Research}
...
\author{
	\textbf{Principal Investigator (Human)} \\
	\textit{Hypothesis \& Conceptual Architecture}
	\and
	\textbf{Computational Co-Author (AI)} \\
	\textit{Formalism \& Geometric Derivation}
	\vspace{0.5cm} \\
	\textit{A Collaborative Synthesis in Theoretical Metric Physics}
}
